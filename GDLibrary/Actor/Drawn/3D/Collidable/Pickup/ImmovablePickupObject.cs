...
namespace GDLibrary
{
    public class ImmovablePickupObject : TriangleMeshObject
    {
        ...
        public ImmovablePickupObject(string id, ActorType actorType, StatusType statusType, Transform3D transform, EffectParameters effectParameters,
            Model model, Model lowPolygonModel, 
            MaterialProperties materialProperties, PickupParameters pickupParameters) 
            : base(id, actorType, statusType,  transform, effectParameters, model, lowPolygonModel, materialProperties)
        {
