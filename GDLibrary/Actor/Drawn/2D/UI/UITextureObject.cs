...
namespace GDLibrary
{
    public class UITextureObject : UIObject
    {
        ...
        public UITextureObject(
            ...
            float layerDepth, 
            Texture2D texture
        ) : this(id, actorType, statusType, transform, color, spriteEffects, layerDepth, texture, new Rectangle(0, 0, texture.Width, texture.Height), new Vector2(texture.Width/2.0f, texture.Height/2.0f)) {
       ...
       public UITextureObject(
        ...
        {
            if (!(obj is UITextureObject other))
                return false;
            else if (this == other)
                return true;
