...
namespace GDApp
{
    public class UIPickingMouseObject : UIMouseObject
    {
         ...
         */
        public UIPickingMouseObject(
            string id, 
            ActorType actorType, 
            Transform2D transform,
            SpriteFont spriteFont, 
            string text, 
            Vector2 textOffsetPosition, 
            Texture2D texture, 
            MouseManager mouseManager, 
            EventDispatcher eventDispatcher
        ) : this(id, actorType, StatusType.Update | StatusType.Drawn, transform, Color.White, SpriteEffects.None, spriteFont, text, textOffsetPosition, Color.White, 0, texture, new Rectangle(0, 0, texture.Width, texture.Height), new Vector2(texture.Width/2, texture.Height/2), mouseManager, eventDispatcher) {
        }
