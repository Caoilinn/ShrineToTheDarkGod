    ...
    public class ThirdPersonController : TargetController
    {
        ...
        public override void Update(GameTime gameTime, IActor actor)
        {
            ...
            if (parent != null && target != null)
            {
                ...
                Vector3 cameraToTarget = Vector3.Transform(target.Transform.Look,
                    Matrix.CreateFromAxisAngle(target.Transform.Right, this.elevationAngle));
                ...
                parent.Transform.Translation = Vector3.Lerp(this.oldTranslation, cameraToTarget * this.distance + target.Transform.Translation, this.translationLerpSpeed);

                //set the camera to look at the target object
                parent.Transform.Look = Vector3.Lerp(this.oldCameraToTarget, cameraToTarget, this.lookLerpSpeed);

                //store old values for lerp
                this.oldTranslation = parent.Transform.Translation;
                this.oldCameraToTarget = -cameraToTarget;
            }
        }

        private void UpdateDistance(GameTime gameTime)
        {
        ...
        {
            int hash = 31 + this.elevationAngle.GetHashCode();
        ...
        public override object Clone()
        {
            return new ThirdPersonController("clone - " + this.ID, //deep
                ...
                this.Target as Actor, //shallow - a ref
                this.distance, //deep
