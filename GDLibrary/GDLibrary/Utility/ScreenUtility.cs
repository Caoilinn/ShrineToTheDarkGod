...
namespace GDLibrary
{
    public class ScreenUtility
    {
        ...
        public enum ScreenType : sbyte
        {
            ...
            MultiPictureInPicture   //<ultiple cameras with PIP e.g. rear-view mirror in a rally game
        }

        public static Integer2 RSGA = new Integer2(160, 100);
        ...
        {
            //Rseduce by whatever padding has been specified
            return new Viewport(
