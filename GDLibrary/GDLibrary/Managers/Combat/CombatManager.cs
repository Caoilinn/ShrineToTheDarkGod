...
namespace GDLibrary
{
    public class CombatManager : PausableGameComponent
    {
        ...
        private AnimatedEnemyObject enemyOnFocus;
        ...
        #region Properties
        public List<AnimatedEnemyObject> Enemies
        {
            get {
                return this.enemies;
            }
        ...
        public AnimatedEnemyObject EnemyOnFocus
        {
            get {
        ...
        public void PopulateEnemies(AnimatedEnemyObject enemy)
        {
            this.enemies.Add(enemy);
        }

        public AnimatedEnemyObject GetEnemy(string id)
        {
            if (enemies != null)
        ...
        public bool RemoveEnemy(Predicate<AnimatedEnemyObject> predicate)
        {
            //Retrieve enemy
            AnimatedEnemyObject enemy = this.enemies.Find(predicate);
        ...
        public int RemoveAllEnemies(Predicate<AnimatedEnemyObject> predicate)
        {
            return this.enemies.RemoveAll(predicate);
        }

        public void PrintStats(AnimatedEnemyObject enemy)
        {
            Console.WriteLine(
                "Player: \n"
